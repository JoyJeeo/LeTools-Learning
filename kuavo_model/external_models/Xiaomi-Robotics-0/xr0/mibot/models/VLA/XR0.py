...
class XR0(nn.Module):
    ...
    def _build_model(self) -> None:
        ...
        self.vlm = Qwen3VLForConditionalGeneration.from_pretrained(
            self.vlm_path, attn_implementation="flash_attention_2", dtype=torch.bfloat16
        ).train()
        ...
        self.rotary_emb = Qwen3VLTextRotaryEmbedding(Qwen3VLTextConfig.from_pretrained(self.vlm_path))
