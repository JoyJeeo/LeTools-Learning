...
so you can override any single value without editing the YAML, e.g.:
    ...
    python kuavo_server/launch.py lingbotvla2_roban_wholebody --checkpoint /tmp/v2/hf_ckpt/model
    python kuavo_server/launch.py xiaomi --checkpoint /tmp/xr0/checkpoint
    python kuavo_server/launch.py xiaomi1 --checkpoint /tmp/xr1/checkpoint
    python kuavo_server/launch.py wallx --checkpoint /tmp/wallx/checkpoint
    python kuavo_server/launch.py g05 --checkpoint /tmp/g05/model_state_dict.pt
"""
...
def main() -> None:
    ...
    ap.add_argument(
        "adapter",
        nargs="?",
        help="adapter name (g05 / openpi / wallx / groot / lingbotvla / lingbotvla2 / xiaomi / ...)",
    )
